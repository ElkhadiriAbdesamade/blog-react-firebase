        ...
        <section className='pt-12 pb-0 max-w-[1320px] mx-auto '>
            <div className='container'>
                ...
                <div className="grid gap-4 grid-cols-3 grid-rows-3">
                    <div className="grid dark:border p-1 rounded-xl">
                        <div className="mb-4">
                            <a href="/">
                                <img src="https://preview.colorlib.com/theme/magdesign/images/img_2.jpg" alt="Img" className="rounded-xl shadow-xl " />
                            </a>
                        </div>
                        <div className="self-center text-[14px]">
                            ...
                            <h2 className='font-bold text-[18px] text-left leading-[1.2] mb-2'><a href="/">Your most unhappy customers are your greatest source of learning.</a></h2>
